...
"""
swcファイルから特定のエリアのコンパートメント番号を抽出して、300_i_glomerular.txtなどとして保存するプログラム
...
#    shell_comps = [i for i in comps if shell(i)]  # extract compartment in the AL shell
    ...
    for i in range(60):
        print output_filename + "_" + str(i) + ".dat"
