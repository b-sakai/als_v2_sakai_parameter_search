...
#PJM --stgout "rank=* %r:./*.param /data/hp160269/sakai/als_v2_sakai/weight_gabaA_ltol/%j/"
#PJM --stgout "rank=* %r:./*.txt /data/hp160269/sakai/als_v2_sakai/weight_gabaA_ltol/%j/record/"
#PJM --stgout "rank=* %r:./*.lweight /data/hp160269/sakai/als_v2_sakai/weight_gabaA_ltol/%j/weight/"
#PJM --stgout "rank=* %r:./*.rweight /data/hp160269/sakai/als_v2_sakai/weight_gabaA_ltol/%j/weight/"
#PJM --stgout "rank=* %r:./*.dat /data/hp160269/sakai/als_v2_sakai/weight_gabaA_ltol/%j/spike/"
...
echo "weight_gabaA_ltol : " | tee "diff.param"
