...
#PJM --stgout "rank=* %r:./*.param /data/hp160269/sakai/als_v2_sakai/%j/"
#PJM --stgout "rank=* %r:./*.txt /data/hp160269/sakai/als_v2_sakai/%j/record/"
#PJM --stgout "rank=* %r:./*.lweight /data/hp160269/sakai/als_v2_sakai/%j/weight/"
#PJM --stgout "rank=* %r:./*.rweight /data/hp160269/sakai/als_v2_sakai/%j/weight/"
#PJM --stgout "rank=* %r:./*.dat /data/hp160269/sakai/als_v2_sakai/%j/spike/"
